...
public class Busqueda extends JFrame {
	 ...
	 */
	public Busqueda() {
		super("B煤squeda reservas - Hotel Alura");
		...
		txtBuscar.setText("Ingrese apellido o n鷐ero de reserva");
		...
		txtBuscar.addFocusListener(new FocusAdapter() {
			...
			public void focusGained(FocusEvent e) {
				if (txtBuscar.getText().equals("Ingrese apellido o n鷐ero de reserva")) {
					txtBuscar.setText("");					
				}
			}
			@Override
		...
		separator_1_2.setBounds(530, 159, 200, 2);
		...
		panel.addTab("Hu閟pedes", new ImageIcon(Busqueda.class.getResource("/imagenes/pessoas.png")), scroll_tableHuespedes, null);
